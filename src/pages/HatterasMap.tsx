...
const islands: Island[] = [
  ...
  { id: 'hatteras', name: 'Hatteras', x: 250, y: 750, path: '/vault', description: 'The secure archive of the collective secrets.', color: '#ffffff' },
];

export const HatterasMap = () => {
    ...
    <div className="max-w-6xl mx-auto py-12 px-4 flex flex-col lg:flex-row gap-12 items-start">
      <div className="flex-1 space-y-8">
        ...
        >
          ...
          <p className="text-slate-400 text-xl font-light tracking-wide">
            Navigate the Hatteras Digital Collective. Each node represents a core module of our ecosystem.
          </p>
        </motion.div>
      ...
      <div className="w-full lg:w-80 space-y-6 lg:mt-24">
        ...
        <div className="glass-card p-6 rounded-2xl border border-white/5 space-y-4">
          <h4 className="text-[10px] font-black uppercase tracking-widest text-slate-500">Collective Stats</h4>
